/** @file TdEquateNewDialog.java
 *
 * @author marco corvi
 * @date may 2017
 *
 * @brief new equate dialog
 * --------------------------------------------------------
...
class TdEquateNewDialog  extends MyDialog
                         implements OnClickListener
{
  ...
  TdEquateNewDialog( Context context, TdViewActivity parent, ArrayList< TdViewCommand > commands )
  {
    super( context );
    mParent   = parent;
    mCommands = commands;
  ...
  public void onCreate( Bundle bundle )
  {
    ...
    for ( int k=0; k<size; ++k ) {
      TdViewCommand vc = mCommands.get( k );
      // List< TdViewStation > vs = vc.mStations;
