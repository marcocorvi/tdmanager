/** @file TdViewStation.java
 *
 * @author marco corvi
 * @date nov 2011
 *
 * @brief survey station display object
 * --------------------------------------------------------
...
class TdViewStation
{
  ...
  TdViewStation( TdStation st, TdViewCommand command, float x0, float y0, boolean equated )
  {
    mStation = st;
    mCommand = command;
    x = x0;
